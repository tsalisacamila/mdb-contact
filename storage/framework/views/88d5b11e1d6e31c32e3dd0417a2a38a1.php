          ...
          <div class="m-4">
            ...
            <div class="row gy-3 mb-4">
              <div class="col-lg-5">
                <div class="me-lg-5">
                  <div class="d-flex">
                    <img src="https://mdbcdn.b-cdn.net/img/bootstrap-ecommerce/items/11.webp" class="border rounded me-3" style="width: 96px; height: 96px;" />
                    <div class="">
            ...
            <div class="row gy-3 mb-4">
              <div class="col-lg-5">
                <div class="me-lg-5">
                  <div class="d-flex">
                    <img src="https://mdbcdn.b-cdn.net/img/bootstrap-ecommerce/items/12.webp" class="border rounded me-3" style="width: 96px; height: 96px;" />
                    <div class="">
            ...
            <div class="row gy-3">
              <div class="col-lg-5">
                <div class="me-lg-5">
                  <div class="d-flex">
                    <img src="https://mdbcdn.b-cdn.net/img/bootstrap-ecommerce/items/13.webp" class="border rounded me-3" style="width: 96px; height: 96px;" />
                    <div class="">
    ...
    <div class="row">
      <div class="col-lg-3 col-md-6 col-sm-6">
        <div class="card px-4 border shadow-0 mb-4 mb-lg-0">
          ...
          <a href="#" class="">
            <img src="https://mdbcdn.b-cdn.net/img/bootstrap-ecommerce/items/7.webp" class="card-img-top rounded-2" />
          </a>
      ...
      <div class="col-lg-3 col-md-6 col-sm-6">
        <div class="card px-4 border shadow-0 mb-4 mb-lg-0">
          ...
          <a href="#" class="">
            <img src="https://mdbcdn.b-cdn.net/img/bootstrap-ecommerce/items/5.webp" class="card-img-top rounded-2" />
          </a>
          <div class="card-body d-flex flex-column pt-3 border-top">
      ...
      <div class="col-lg-3 col-md-6 col-sm-6">
        <div class="card px-4 border shadow-0">
          ...
          <a href="#" class="">
            <img src="https://mdbcdn.b-cdn.net/img/bootstrap-ecommerce/items/9.webp" class="card-img-top rounded-2" />
          </a>
          <div class="card-body d-flex flex-column pt-3 border-top">
      ...
      <div class="col-lg-3 col-md-6 col-sm-6">
        <div class="card px-4 border shadow-0">
          ...
          <a href="#" class="">
            <img src="https://mdbcdn.b-cdn.net/img/bootstrap-ecommerce/items/10.webp" class="card-img-top rounded-2" />
          </a>
          <div class="card-body d-flex flex-column pt-3 border-top">
...
<?php /**PATH D:\xampp8\htdocs\lav-try\resources\views/cart.blade.php ENDPATH**/ ?>